...
<div class="container-fluid ">
 ...
 <form method="post">
    ...
    <div class="form-group">
       <label class="control-label" for="ln">Direccion:</label>
       <div class="col">
          <input type="text" class="form-control text-uppercase" name="direccion" placeholder="Direccion"
          required value="<?php if(isset($_GET['editar'])) echo $getROW['direccion'];  ?>"  />
       </div>
    </div>
    <div class="form-group">
       <label class="control-label" for="ln">Telefono:</label>
       <div class="col">
          <input type="text" class="form-control text-uppercase" name="telefono" placeholder="Telefono"
 ...
 <table class="table table-hover table-bordered shadow p-3 mb-5 bg-danger rounded ">
    ...
    <?php
     $res = $MySQLiconn->query("SELECT * FROM perfiles");
